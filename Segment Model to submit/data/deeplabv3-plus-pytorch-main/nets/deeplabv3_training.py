...
def soft_Loss(inputs, target, cls_weights, num_classes=21):
    n, c, h, w = inputs.size()
    ...
    dice_loss = DiceLoss(mode='multiclass',ignore_index = num_classes, classes = cls_weights)(inputs, target)
    ce_loss = SoftCrossEntropyLoss(smooth_factor=0.1, ignore_index = num_classes)(inputs, target)
...
def get_lr_scheduler(lr_decay_type, lr, min_lr, total_iters, warmup_iters_ratio = 0.1, warmup_lr_ratio = 0.1, no_aug_iter_ratio = 0.3, step_num = 10):
    ...
    if lr_decay_type == "cos":
        warmup_total_iters  = min(max(warmup_iters_ratio * total_iters, 1), 8)
