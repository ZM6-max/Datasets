...
class OverlapPatchEmbed(BaseModule):
    ...
    def forward(self, x):
        ...
        return x, H, W
def SegNext_L(pretrained=False, **kwargs):
    model =  MSCAN(
        ...
        **kwargs)    
    if pretrained:
        msg = model.load_state_dict(torch.load('/data/tangchen/deeplabv3-plus-pytorch-main/model_data/mscan_l.pth', map_location=lambda storage, loc: storage)['state_dict'], strict=False)
        print(msg)
    return model
